...
const Admin = () => {
    ...
    const ManageComments = () => {
        ...
        const updateComment = async (createdAt, approved) => {
            ...
            try {
                const response = await axios.put('http://localhost:5000/comments/updateApproved', data);
        ...
        function commentsDelete(createdAt) {
            axios.delete(`http://localhost:5000/deletecomments/${createdAt}`)
                .then(response => console.log())
                .catch(error => console.error(error));
        }

        // function commentsUpdate(createdAt) {
        //     axios.put(`http://localhost:5000/updatecomments/${createdAt}`, {
    ...
    const ManageAnnouncements = () => {
        ...
        const addAnnouncement = async (event) => {
            ...
            try {
                axios.post('http://localhost:5000/admin/announcements', {
                    title,
                    description,
                });
                getAnnouncements();
        ...
        const annocementfetchApprovedStatus = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/get-approved/678ebdeddfb927ed6a38aa95`);
        ...
        useEffect(() => {
            const updateApproved = async () => {
                try {
                    const response = await axios.put(`http://localhost:5000/update-approved/678ebdeddfb927ed6a38aa95`, {
                        approved,
                    });
