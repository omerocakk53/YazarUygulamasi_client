...
const Admin = () => {
    ...
    const ManageComments = () => {
        ...
        const updateComment = async (createdAt, approved) => {
            ...
            try {
                const response = await axios.put('/comments', data);
        ...
        function commentsDelete(createdAt) {
            axios.delete(`/comments/${createdAt}`)
                .then(response => console.log())
                .catch(error => console.error(error));
        }

        // function commentsUpdate(createdAt) {
        //     axios.put(`/updatecomments{createdAt}`, {
    ...
    const ManageAnnouncements = () => {
        ...
        const annocementfetchApprovedStatus = async () => {
            try {
                const response = await axios.get(`/announcements/678ebdeddfb927ed6a38aa95`);
        ...
        useEffect(() => {
            const updateApproved = async () => {
                try {
                    const response = await axios.put(`/announcements/678ebdeddfb927ed6a38aa95`, {
                        approved,
                    });
